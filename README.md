# DocuSense AI — Contract & Policy Clause Explainer

**Hack & Fest AI Innovation Hackathon — SRM Institute of Science and Technology**
*Organized by Ansnicore Solutions (Day 4)*

### 📌 Problem Statement 1.2: Contract / Policy Clause Explainer
**Team 2 — Track 1: Document Intelligence Systems**
...
**DocuSense AI** is a 100% local, privacy-first legal document intelligence platform built specifically for **Problem Statement 1.2: Contract / Policy Clause Explainer**. It translates complex legal agreements, Land Sale Deeds, Lease Policies, Terms of Service (ToS), and Contracts into clear, plain language.
...
## 📁 Hackathon Presentation & Documentation Artifacts

- 📄 **`Docusense AI -Hackthon.pdf`**: Complete Project Proposal & System Documentation
- 📊 **`ppt.pdf`**: Official Hackathon Presentation Deck
- 📋 **`PROMPT_ENGINEERING_GUIDE.pdf`**: Full Prompt Engineering Guide (ROLE/CONTEXT/TASK/FORMAT/CONSTRAINT)
- 📝 **`project_prompts_history.txt`**: Complete Prompt Log History from Start to Finish
...
| 🖥️ **Native Desktop App Launcher** | Launch as a standalone desktop window using `pywebview` | `desktop_app.py` & `DocuSense_AI.bat` |
...
Double click `DocuSense_AI.bat` or run:
```bash
